...
def test_pair_with_pnl(pair, df_full, start_date, end_date, sl_mult, tp_mult, risk_pct):
...
pairs = ["EURUSD", "GBPUSD", "USDJPY", "AUDUSD", "USDCAD", "USDCHF", "NZDUSD", "GBPCHF", "XAUUSD", "XAGUSD"]

print("Testing SL2.0/TP0.5 with actual PnL on 10k account...")
print("=" * 70)

all_trades = []
balance = 10000
daily_balance = {"2026-02-01": balance}
...
for pair in pairs:
    ...
    trades = test_pair_with_pnl(pair, df_full, "2026-02-01", "2026-02-28", 2.0, 0.5, 0.5)
